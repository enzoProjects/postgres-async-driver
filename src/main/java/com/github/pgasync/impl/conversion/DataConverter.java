...
public class DataConverter {
    ...
    public LocalDate toDate(Oid oid, byte[] value) {
    ...
    public LocalDateTime toTimestamp(Oid oid, byte[] value) {
    ...
    public byte[] fromObject(Object o) {
        ...
        if (o instanceof LocalTime) {
            return TemporalConversions.fromTime((LocalTime) o);
        }
        if (o instanceof LocalDateTime) {
            return TemporalConversions.fromTimestamp((LocalDateTime) o);
        }
        if (o instanceof LocalDate) {
            return TemporalConversions.fromDate((LocalDate) o);
        }
